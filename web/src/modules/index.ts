...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    description: 'OEE per machine, daily output vs plan, shift comparison & WO progress',
    icon: 'production',
    color: '#1D4ED8',
  ...
  },
  {
    ...
    description: 'FPY trend, defect Pareto, category breakdown & quality cost',
    icon: 'quality',
    color: '#7C3AED',
    path: '/dashboard/quality',
    available: true,
    roles: ['Admin', 'Manager', 'QualityEngineer'],
    tabs: [],
  },
  {
    id: 'dash-inventory',
    label: 'Inventory Health',
    description: 'Stock by location, GRN trend, low-stock & expiring lot alerts',
    icon: 'bom',
    color: '#0F766E',
  ...
  },
  {
    ...
    description: 'SO on-time rate, overdue orders & monthly fulfillment trend',
    icon: 'integration',
    color: '#B45309',

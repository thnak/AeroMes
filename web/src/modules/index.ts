...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    label: 'Factory KPIs',
    description: 'Manager view — factory KPIs, OEE, shift output, defect pareto & SO fulfillment',
    icon: 'reports',
    color: '#044A42',
  ...
  },
  {
    id: 'my-dashboard',
    label: 'My Dashboard',
    description: 'Personal production dashboard — my output, defect rate & active jobs',
    icon: 'production',
    color: '#3A9188',
    path: '/my-dashboard',
    available: true,

...
public class RejectEngChangeHandler(
    ...
    IUnitOfWork uow) : ICommandHandler<RejectEngChangeCommand, ValidationResult<Unit>>
{
    public async Task<ValidationResult<Unit>> HandleAsync(RejectEngChangeCommand cmd, CancellationToken ct)
    {

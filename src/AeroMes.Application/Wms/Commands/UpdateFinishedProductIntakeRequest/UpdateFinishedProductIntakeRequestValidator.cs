...
public class UpdateFinishedProductIntakeRequestValidator
    : AbstractValidator<UpdateFinishedProductIntakeRequestCommand>
{
    public UpdateFinishedProductIntakeRequestValidator()
    {

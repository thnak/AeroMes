...
public class SignalAgg1min
{
    ...
    private SignalAgg1min() { }

    public static SignalAgg1min Create(string machineCode, string tagKey, DateTimeOffset bucketAt,

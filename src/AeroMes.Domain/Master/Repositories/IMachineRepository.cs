...
public interface IMachineRepository
{
    ...
    Task<IReadOnlyList<Machine>> GetByTypeAsync(string machineType, bool activeOnly = true, CancellationToken ct = default);
    Task<IReadOnlyList<Machine>> GetCompatibleForMoldAsync(int minClampingForceTons, CancellationToken ct = default);

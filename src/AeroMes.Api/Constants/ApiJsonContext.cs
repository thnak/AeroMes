...
// Dashboard KPI (issue #321)
[JsonSerializable(typeof(FactoryKpiDto))]
[JsonSerializable(typeof(OeeByMachineDto))]
[JsonSerializable(typeof(IReadOnlyList<OeeByMachineDto>))]
[JsonSerializable(typeof(List<OeeByMachineDto>))]
[JsonSerializable(typeof(ShiftOutputDto))]
[JsonSerializable(typeof(IReadOnlyList<ShiftOutputDto>))]
[JsonSerializable(typeof(List<ShiftOutputDto>))]
[JsonSerializable(typeof(DefectParetoItemDto))]
[JsonSerializable(typeof(IReadOnlyList<DefectParetoItemDto>))]
[JsonSerializable(typeof(List<DefectParetoItemDto>))]
[JsonSerializable(typeof(LowStockAlertDto))]
[JsonSerializable(typeof(IReadOnlyList<LowStockAlertDto>))]
[JsonSerializable(typeof(List<LowStockAlertDto>))]
[JsonSerializable(typeof(ExpiringLotAlertDto))]
[JsonSerializable(typeof(IReadOnlyList<ExpiringLotAlertDto>))]
[JsonSerializable(typeof(List<ExpiringLotAlertDto>))]
[JsonSerializable(typeof(InventoryAlertSummaryDto))]
[JsonSerializable(typeof(OverdueSoDto))]
[JsonSerializable(typeof(IReadOnlyList<OverdueSoDto>))]
[JsonSerializable(typeof(List<OverdueSoDto>))]
[JsonSerializable(typeof(SoFulfillmentDto))]
[JsonSerializable(typeof(MyJobSummaryDto))]
[JsonSerializable(typeof(IReadOnlyList<MyJobSummaryDto>))]
[JsonSerializable(typeof(List<MyJobSummaryDto>))]
